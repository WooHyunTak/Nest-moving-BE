...
import getRatingsByMoverIds from '../movers/getRatingsByMover';
import processMoverData from '../movers/processMoverData';
...
async function processQuotes(
  ...
  const ratingsByMover = await getRatingsByMoverIds(moverIds, moverRepository);
