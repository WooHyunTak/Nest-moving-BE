...
CREATE TABLE "_CustomerToMover" (
    ...
    CONSTRAINT "_CustomerToMover_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_MoverToMovingRequest" (
    ...
    CONSTRAINT "_MoverToMovingRequest_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_Rejected" (
    ...
    CONSTRAINT "_Rejected_AB_pkey" PRIMARY KEY ("A","B")
);
